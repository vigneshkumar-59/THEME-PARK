...
function Pay3() 
{
  ...
  const handlesubmit = (e)=>{
    e.preventDefault();
    if(Name === "" || mobilenumber === "" || Visitingdate === "" ){
  ...
  return (
    <div className="pay">
      <br></br>
             ...
             <br></br>              
             <br></br>           
             <input type="text" maxLength="10" placeholder="Mobile No."value={mobilenumber}onChange={(e)=>setmobilenumber(e.target.value)} /><br></br><br></br>
             <input type="date" placeholder=" "value={Visitingdate}onChange={(e)=>setdate(e.target.value)}/>
             <br></br>              
             <br></br>
             <input type="time" placeholder=" " value={Visitingtime}onChange={(e)=>settime(e.target.value)}/><br></br> <br></br>
              <p1>TotalAmount : 2700.00</p1>
             <br></br>
             <br></br>               
