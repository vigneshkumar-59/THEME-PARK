  ...
  return (
    <div className="pay">
      <br></br>
             ...
             <br></br>              
             <br></br>           
             <input type="numberic" maxLength="10" placeholder="Mobile No."value={mobilenumber}onChange={(e)=>setmobilenumber(e.target.value)} /><br></br><br></br>
